\pagebreak
\subsection{Add Immediate, Conditional}
\verb|addi.c DR,SR,IMM|
\subsubsection{Encoding}
This instruction will use the RRI format. 
The operation field (OP) wil be $0010_2$
...
\begin{center}
    \begin{tabular}{|c|c|c|}
        ...
        \hline
        Add Link & \verb|adl| & \verb|addi.c ac,ac,1|  \\
        \hline
        Jump Relative Conditional & \verb|jr.c OFFSET| & \verb|addi.c pc,pc,OFFSET| \\
        \hline
        Jump Conditional & \verb|jmp.c| & \verb|addi.c pc,ac,0| \\
        \hline
    \end{tabular}
\end{center}
