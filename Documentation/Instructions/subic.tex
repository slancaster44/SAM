\pagebreak
\subsection{Subtract Immediate, Conditional}
\verb|subi.c DR,SR,IMM|
...
\begin{center}
    \begin{tabular}{|c|c|c|}
        ...
        \hline
        No-Operation & \verb|nop| & \verb|subi.c zr,zr,0|  \\
        \hline
        Add Link & \verb|adl| & \verb|subi.c ac,ac,-1| \\
        \hline
        Jump Relative Conditional & \verb|jr.c OFFSET| & \verb|subi.c pc,pc,OFFSET| \\
        \hline
        Jump Conditional & \verb|jmp.c| & \verb|subi.c pc,ac,0| \\
        \hline
    \end{tabular}
\end{center}
